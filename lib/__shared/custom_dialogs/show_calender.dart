          ...
          children: [
            IconButton(
              onPressed: () {
                ...
                startDate =
                    DateTime(shownDate.year, shownDate.month, 1).weekday;
                setState(() {});
              },
            ...
            Text(
              ...
              style:
                  AppExTheme.titleSmall(context).copyWith(color: Colors.black),
            ),
            IconButton(
              onPressed: () {
                shownDate = DateTime(
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                getColor(selectedDate, shownDate, indexDay + 1),
                            border: Border.all(
                              color: getBorderColor(
                                  shownDate, DateTime.now(), indexDay),
                            ),
